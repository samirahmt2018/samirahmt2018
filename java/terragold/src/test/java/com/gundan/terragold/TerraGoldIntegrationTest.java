...
// Optional: check status after printing
        ...
        var empReq = new EmployeeCreateRequest(
                "Kidane Gebremichael", "EMP-001", "0911123456", "Purchaser", "Finance", LocalDate.now(),new BigDecimal("25000"), "Experienced purchaser for mining supplies");
    ...
    void fullBusinessFlow_RealEthiopianMiningDay() throws Exception {
        ...
        // Step 4: Record 182.4 grams gold produced
        var prodReq = new ProductionRequest(new BigDecimal("182.4"), new BigDecimal("92.5"), 5L, "SHIRE-2025-11-29");
